...
export class QueryClientImpl {
    ...
    Scavenge(request) {
        ...
        const promise = this.rpc.request("cosmonaut.bzedgev5.scavenge.Query", "Scavenge", data);
    ...
    ScavengeAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.bzedgev5.scavenge.Query", "ScavengeAll", data);
    ...
    Commit(request) {
        ...
        const promise = this.rpc.request("cosmonaut.bzedgev5.scavenge.Query", "Commit", data);
    ...
    CommitAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.bzedgev5.scavenge.Query", "CommitAll", data);
