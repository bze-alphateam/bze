...
import { EpochStartEvent } from "./module/types/epochs/events"
import { EpochEndEvent } from "./module/types/epochs/events"
	...
	actions: {
		...
		async QueryEpochInfos({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				let value= (await queryClient.queryEpochInfos()).data
