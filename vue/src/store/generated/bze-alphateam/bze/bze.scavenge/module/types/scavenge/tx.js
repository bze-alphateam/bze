...
export class MsgClientImpl {
    ...
    SubmitScavenge(request) {
        ...
        const promise = this.rpc.request("bze.scavenge.Msg", "SubmitScavenge", data);
    ...
    CommitSolution(request) {
        ...
        const promise = this.rpc.request("bze.scavenge.Msg", "CommitSolution", data);
    ...
    RevealSolution(request) {
        ...
        const promise = this.rpc.request("bze.scavenge.Msg", "RevealSolution", data);
