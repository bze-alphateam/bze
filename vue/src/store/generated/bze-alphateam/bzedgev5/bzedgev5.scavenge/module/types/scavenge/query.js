...
export class QueryClientImpl {
    ...
    Scavenge(request) {
        ...
        const promise = this.rpc.request("bzedgev5.scavenge.Query", "Scavenge", data);
    ...
    ScavengeAll(request) {
        ...
        const promise = this.rpc.request("bzedgev5.scavenge.Query", "ScavengeAll", data);
    ...
    CommitAll(request) {
        ...
        const promise = this.rpc.request("bzedgev5.scavenge.Query", "CommitAll", data);
