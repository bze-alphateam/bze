...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/bzedgev5/scavenge/commit
         */
        this.queryCommitAll = (query, params = {}) => this.request({
            path: `/bzedgev5/scavenge/commit`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/bzedgev5/scavenge/commit/{index}
         */
        this.queryCommit = (index, params = {}) => this.request({
            path: `/bzedgev5/scavenge/commit/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/bzedgev5/scavenge/scavenge
         */
        this.queryScavengeAll = (query, params = {}) => this.request({
            path: `/bzedgev5/scavenge/scavenge`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/bzedgev5/scavenge/scavenge/{index}
         */
        this.queryScavenge = (index, params = {}) => this.request({
            path: `/bzedgev5/scavenge/scavenge/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
