...
export const MsgRevealSolution = {
    encode(message, writer = Writer.create()) {
        ...
        if (message.scavengeIndex !== "") {
            writer.uint32(26).string(message.scavengeIndex);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.scavengeIndex = reader.string();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.scavengeIndex !== undefined && object.scavengeIndex !== null) {
            message.scavengeIndex = String(object.scavengeIndex);
        }
        else {
            message.scavengeIndex = "";
        }
        return message;
    },
    toJSON(message) {
        ...
        message.scavengeIndex !== undefined &&
            (obj.scavengeIndex = message.scavengeIndex);
        return obj;
    },
    fromPartial(object) {
        const message = { ...baseMsgRevealSolution };
        ...
        if (object.scavengeIndex !== undefined && object.scavengeIndex !== null) {
            message.scavengeIndex = object.scavengeIndex;
        }
        else {
            message.scavengeIndex = "";
        }
...
export class MsgClientImpl {
    ...
    SubmitScavenge(request) {
        ...
        const promise = this.rpc.request("bzedgev5.scavenge.Msg", "SubmitScavenge", data);
    ...
    CommitSolution(request) {
        ...
        const promise = this.rpc.request("bzedgev5.scavenge.Msg", "CommitSolution", data);
    ...
    RevealSolution(request) {
        ...
        const promise = this.rpc.request("bzedgev5.scavenge.Msg", "RevealSolution", data);
