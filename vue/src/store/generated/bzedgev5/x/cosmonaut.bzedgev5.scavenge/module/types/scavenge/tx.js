...
export class MsgClientImpl {
    ...
    SubmitScavenge(request) {
        ...
        const promise = this.rpc.request("cosmonaut.bzedgev5.scavenge.Msg", "SubmitScavenge", data);
    ...
    CommitSolution(request) {
        ...
        const promise = this.rpc.request("cosmonaut.bzedgev5.scavenge.Msg", "CommitSolution", data);
    ...
    RevealSolution(request) {
        ...
        const promise = this.rpc.request("cosmonaut.bzedgev5.scavenge.Msg", "RevealSolution", data);
