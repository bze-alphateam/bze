...
var (
	md_MsgSetDenomBranding          protoreflect.MessageDescriptor
	fd_MsgSetDenomBranding_creator  protoreflect.FieldDescriptor
	fd_MsgSetDenomBranding_denom    protoreflect.FieldDescriptor
	fd_MsgSetDenomBranding_branding protoreflect.FieldDescriptor
)

func init() {
	file_bze_tokenfactory_tx_proto_init()
	md_MsgSetDenomBranding = File_bze_tokenfactory_tx_proto.Messages().ByName("MsgSetDenomBranding")
	fd_MsgSetDenomBranding_creator = md_MsgSetDenomBranding.Fields().ByName("creator")
	fd_MsgSetDenomBranding_denom = md_MsgSetDenomBranding.Fields().ByName("denom")
	fd_MsgSetDenomBranding_branding = md_MsgSetDenomBranding.Fields().ByName("branding")
}

var _ protoreflect.Message = (*fastReflection_MsgSetDenomBranding)(nil)

type fastReflection_MsgSetDenomBranding MsgSetDenomBranding

func (x *MsgSetDenomBranding) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgSetDenomBranding)(x)
}

func (x *MsgSetDenomBranding) slowProtoReflect() protoreflect.Message {
	mi := &file_bze_tokenfactory_tx_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgSetDenomBranding_messageType fastReflection_MsgSetDenomBranding_messageType
var _ protoreflect.MessageType = fastReflection_MsgSetDenomBranding_messageType{}

type fastReflection_MsgSetDenomBranding_messageType struct{}

func (x fastReflection_MsgSetDenomBranding_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgSetDenomBranding)(nil)
}
func (x fastReflection_MsgSetDenomBranding_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgSetDenomBranding)
}
func (x fastReflection_MsgSetDenomBranding_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSetDenomBranding
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgSetDenomBranding) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSetDenomBranding
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgSetDenomBranding) Type() protoreflect.MessageType {
	return _fastReflection_MsgSetDenomBranding_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgSetDenomBranding) New() protoreflect.Message {
	return new(fastReflection_MsgSetDenomBranding)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgSetDenomBranding) Interface() protoreflect.ProtoMessage {
	return (*MsgSetDenomBranding)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgSetDenomBranding) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Creator != "" {
		value := protoreflect.ValueOfString(x.Creator)
		if !f(fd_MsgSetDenomBranding_creator, value) {
			return
		}
	}
	if x.Denom != "" {
		value := protoreflect.ValueOfString(x.Denom)
		if !f(fd_MsgSetDenomBranding_denom, value) {
			return
		}
	}
	if x.Branding != nil {
		value := protoreflect.ValueOfMessage(x.Branding.ProtoReflect())
		if !f(fd_MsgSetDenomBranding_branding, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgSetDenomBranding) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bze.tokenfactory.MsgSetDenomBranding.creator":
		return x.Creator != ""
	case "bze.tokenfactory.MsgSetDenomBranding.denom":
		return x.Denom != ""
	case "bze.tokenfactory.MsgSetDenomBranding.branding":
		return x.Branding != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBranding"))
		}
		panic(fmt.Errorf("message bze.tokenfactory.MsgSetDenomBranding does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBranding) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "bze.tokenfactory.MsgSetDenomBranding.creator":
		x.Creator = ""
	case "bze.tokenfactory.MsgSetDenomBranding.denom":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgSetDenomBranding) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "bze.tokenfactory.MsgSetDenomBranding.creator":
		value := x.Creator
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message bze.tokenfactory.MsgSetDenomBranding does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBranding) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "bze.tokenfactory.MsgSetDenomBranding.creator":
		x.Creator = value.Interface().(string)
	case "bze.tokenfactory.MsgSetDenomBranding.denom":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBranding) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "bze.tokenfactory.MsgSetDenomBranding.branding":
		if x.Branding == nil {
	...
	case "bze.tokenfactory.MsgSetDenomBranding.creator":
		panic(fmt.Errorf("field creator of message bze.tokenfactory.MsgSetDenomBranding is not mutable"))
	case "bze.tokenfactory.MsgSetDenomBranding.denom":
		panic(fmt.Errorf("field denom of message bze.tokenfactory.MsgSetDenomBranding is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBranding"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgSetDenomBranding) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "bze.tokenfactory.MsgSetDenomBranding.creator":
		return protoreflect.ValueOfString("")
	case "bze.tokenfactory.MsgSetDenomBranding.denom":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgSetDenomBranding) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bze.tokenfactory.MsgSetDenomBranding", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgSetDenomBranding) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBranding) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgSetDenomBranding) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgSetDenomBranding) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgSetDenomBranding)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSetDenomBranding: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSetDenomBranding: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgSetDenomBrandingResponse protoreflect.MessageDescriptor
)

func init() {
	file_bze_tokenfactory_tx_proto_init()
	md_MsgSetDenomBrandingResponse = File_bze_tokenfactory_tx_proto.Messages().ByName("MsgSetDenomBrandingResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgSetDenomBrandingResponse)(nil)

type fastReflection_MsgSetDenomBrandingResponse MsgSetDenomBrandingResponse

func (x *MsgSetDenomBrandingResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgSetDenomBrandingResponse)(x)
}

func (x *MsgSetDenomBrandingResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_bze_tokenfactory_tx_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgSetDenomBrandingResponse_messageType fastReflection_MsgSetDenomBrandingResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgSetDenomBrandingResponse_messageType{}

type fastReflection_MsgSetDenomBrandingResponse_messageType struct{}

func (x fastReflection_MsgSetDenomBrandingResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgSetDenomBrandingResponse)(nil)
}
func (x fastReflection_MsgSetDenomBrandingResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgSetDenomBrandingResponse)
}
func (x fastReflection_MsgSetDenomBrandingResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSetDenomBrandingResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgSetDenomBrandingResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSetDenomBrandingResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgSetDenomBrandingResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgSetDenomBrandingResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgSetDenomBrandingResponse) New() protoreflect.Message {
	return new(fastReflection_MsgSetDenomBrandingResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgSetDenomBrandingResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgSetDenomBrandingResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgSetDenomBrandingResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgSetDenomBrandingResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBrandingResponse"))
		}
		panic(fmt.Errorf("message bze.tokenfactory.MsgSetDenomBrandingResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBrandingResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBrandingResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgSetDenomBrandingResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBrandingResponse"))
		}
		panic(fmt.Errorf("message bze.tokenfactory.MsgSetDenomBrandingResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBrandingResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBrandingResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBrandingResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBrandingResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgSetDenomBrandingResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.tokenfactory.MsgSetDenomBrandingResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgSetDenomBrandingResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bze.tokenfactory.MsgSetDenomBrandingResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgSetDenomBrandingResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSetDenomBrandingResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgSetDenomBrandingResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgSetDenomBrandingResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgSetDenomBrandingResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSetDenomBrandingResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSetDenomBrandingResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
func (x *MsgSetDenomBranding) Reset() {
	*x = MsgSetDenomBranding{}
	if protoimpl.UnsafeEnabled {
		mi := &file_bze_tokenfactory_tx_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgSetDenomBranding) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgSetDenomBranding) ProtoMessage() {}

// Deprecated: Use MsgSetDenomBranding.ProtoReflect.Descriptor instead.
func (*MsgSetDenomBranding) Descriptor() ([]byte, []int) {
	return file_bze_tokenfactory_tx_proto_rawDescGZIP(), []int{12}
}

func (x *MsgSetDenomBranding) GetCreator() string {
	if x != nil {
		return x.Creator
	}
	return ""
...
func (x *MsgSetDenomBranding) GetDenom() string {
	if x != nil {
		return x.Denom
	}
	return ""
...
func (x *MsgSetDenomBranding) GetBranding() *DenomBranding {
	if x != nil {
		return x.Branding
	}
	return nil
...
func (x *MsgSetDenomBrandingResponse) Reset() {
	*x = MsgSetDenomBrandingResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_bze_tokenfactory_tx_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgSetDenomBrandingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgSetDenomBrandingResponse) ProtoMessage() {}

// Deprecated: Use MsgSetDenomBrandingResponse.ProtoReflect.Descriptor instead.
func (*MsgSetDenomBrandingResponse) Descriptor() ([]byte, []int) {
	return file_bze_tokenfactory_tx_proto_rawDescGZIP(), []int{13}
}
...
var file_bze_tokenfactory_tx_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x25, 0x62, 0x7a, 0x65, 0x2f, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x64, 0x65, 0x6e, 0x6f,
	0x6d, 0x5f, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x62,
	...
	0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x8a, 0xe7, 0xb0, 0x2a, 0x22, 0x62, 0x7a,
	0x65, 0x2f, 0x78, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x3a, 0x37, 0x82, 0xe7, 0xb0, 0x2a, 0x07, 0x63, 0x72,
	...
	,
	...
	,
	...
	0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x62, 0x7a, 0x65, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x66,
	0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0xa2, 0x02, 0x03, 0x42, 0x54, 0x58, 0xaa, 0x02, 0x10, 0x42,
	0x7a, 0x65, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0xca,
	0x02, 0x10, 0x42, 0x7a, 0x65, 0x5c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f,
	0x72, 0x79, 0xe2, 0x02, 0x1c, 0x42, 0x7a, 0x65, 0x5c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61,
	0x63, 0x74, 0x6f, 0x72, 0x79, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0xea, 0x02, 0x11, 0x42, 0x7a, 0x65, 0x3a, 0x3a, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61,
...
var file_bze_tokenfactory_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_bze_tokenfactory_tx_proto_goTypes = []interface{}{
	...
	(*MsgSetDenomBranding)(nil),         // 12: bze.tokenfactory.MsgSetDenomBranding
	(*MsgSetDenomBrandingResponse)(nil), // 13: bze.tokenfactory.MsgSetDenomBrandingResponse
	(*Params)(nil),                      // 14: bze.tokenfactory.Params
	(*v1beta1.Metadata)(nil),            // 15: cosmos.bank.v1beta1.Metadata
	(*DenomBranding)(nil),               // 16: bze.tokenfactory.DenomBranding
}
var file_bze_tokenfactory_tx_proto_depIdxs = []int32{
	14, // 0: bze.tokenfactory.MsgUpdateParams.params:type_name -> bze.tokenfactory.Params
	15, // 1: bze.tokenfactory.MsgSetDenomMetadata.metadata:type_name -> cosmos.bank.v1beta1.Metadata
	16, // 2: bze.tokenfactory.MsgSetDenomBranding.branding:type_name -> bze.tokenfactory.DenomBranding
	0,  // 3: bze.tokenfactory.Msg.UpdateParams:input_type -> bze.tokenfactory.MsgUpdateParams
	2,  // 4: bze.tokenfactory.Msg.CreateDenom:input_type -> bze.tokenfactory.MsgCreateDenom
	4,  // 5: bze.tokenfactory.Msg.Mint:input_type -> bze.tokenfactory.MsgMint
	6,  // 6: bze.tokenfactory.Msg.Burn:input_type -> bze.tokenfactory.MsgBurn
	8,  // 7: bze.tokenfactory.Msg.ChangeAdmin:input_type -> bze.tokenfactory.MsgChangeAdmin
	10, // 8: bze.tokenfactory.Msg.SetDenomMetadata:input_type -> bze.tokenfactory.MsgSetDenomMetadata
	12, // 9: bze.tokenfactory.Msg.SetDenomBranding:input_type -> bze.tokenfactory.MsgSetDenomBranding
	1,  // 10: bze.tokenfactory.Msg.UpdateParams:output_type -> bze.tokenfactory.MsgUpdateParamsResponse
	3,  // 11: bze.tokenfactory.Msg.CreateDenom:output_type -> bze.tokenfactory.MsgCreateDenomResponse
	5,  // 12: bze.tokenfactory.Msg.Mint:output_type -> bze.tokenfactory.MsgMintResponse
	7,  // 13: bze.tokenfactory.Msg.Burn:output_type -> bze.tokenfactory.MsgBurnResponse
	9,  // 14: bze.tokenfactory.Msg.ChangeAdmin:output_type -> bze.tokenfactory.MsgChangeAdminResponse
	11, // 15: bze.tokenfactory.Msg.SetDenomMetadata:output_type -> bze.tokenfactory.MsgSetDenomMetadataResponse
	13, // 16: bze.tokenfactory.Msg.SetDenomBranding:output_type -> bze.tokenfactory.MsgSetDenomBrandingResponse
...
func file_bze_tokenfactory_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bze_tokenfactory_tx_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgSetDenomBranding); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bze_tokenfactory_tx_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgSetDenomBrandingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
