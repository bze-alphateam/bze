...
const (
	Query_Params_FullMethodName       = "/bze.epochs.Query/Params"
	Query_EpochInfos_FullMethodName   = "/bze.epochs.Query/EpochInfos"
	Query_CurrentEpoch_FullMethodName = "/bze.epochs.Query/CurrentEpoch"
)
