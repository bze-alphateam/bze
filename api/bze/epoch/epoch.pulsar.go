...
func init() {
	...
	md_EpochInfo = File_bze_epoch_epoch_proto.Messages().ByName("EpochInfo")
...
func (x *EpochInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_bze_epoch_epoch_proto_msgTypes[0]
...
func (x *fastReflection_EpochInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bze.epoch.EpochInfo.identifier":
		return x.Identifier != ""
	case "bze.epoch.EpochInfo.start_time":
		return x.StartTime != nil
	case "bze.epoch.EpochInfo.duration":
		return x.Duration != nil
	case "bze.epoch.EpochInfo.current_epoch":
		return x.CurrentEpoch != int64(0)
	case "bze.epoch.EpochInfo.current_epoch_start_time":
		return x.CurrentEpochStartTime != nil
	case "bze.epoch.EpochInfo.epoch_counting_started":
		return x.EpochCountingStarted != false
	case "bze.epoch.EpochInfo.current_epoch_start_height":
		return x.CurrentEpochStartHeight != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.epoch.EpochInfo"))
		}
		panic(fmt.Errorf("message bze.epoch.EpochInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bze.epoch.EpochInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EpochInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "bze.epoch.EpochInfo.identifier":
		panic(fmt.Errorf("field identifier of message bze.epoch.EpochInfo is not mutable"))
	case "bze.epoch.EpochInfo.current_epoch":
		panic(fmt.Errorf("field current_epoch of message bze.epoch.EpochInfo is not mutable"))
	case "bze.epoch.EpochInfo.epoch_counting_started":
		panic(fmt.Errorf("field epoch_counting_started of message bze.epoch.EpochInfo is not mutable"))
	case "bze.epoch.EpochInfo.current_epoch_start_height":
		panic(fmt.Errorf("field current_epoch_start_height of message bze.epoch.EpochInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bze.epoch.EpochInfo"))
		}
...
func (x *fastReflection_EpochInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bze.epoch.EpochInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EpochInfo) Descriptor() ([]byte, []int) {
	return file_bze_epoch_epoch_proto_rawDescGZIP(), []int{0}
}
...
var File_bze_epoch_epoch_proto protoreflect.FileDescriptor

var file_bze_epoch_epoch_proto_rawDesc = []byte{
	0x0a, 0x15, 0x62, 0x7a, 0x65, 0x2f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x2f, 0x65, 0x70, 0x6f, 0x63,
	0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x62, 0x7a, 0x65, 0x2e, 0x65, 0x70, 0x6f,
	0x63, 0x68, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f,
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x90, 0x04, 0x0a, 0x09, 0x45, 0x70,
	...
	,
	...
	,
}

var (
	file_bze_epoch_epoch_proto_rawDescOnce sync.Once
	file_bze_epoch_epoch_proto_rawDescData = file_bze_epoch_epoch_proto_rawDesc
)

func file_bze_epoch_epoch_proto_rawDescGZIP() []byte {
	file_bze_epoch_epoch_proto_rawDescOnce.Do(func() {
		file_bze_epoch_epoch_proto_rawDescData = protoimpl.X.CompressGZIP(file_bze_epoch_epoch_proto_rawDescData)
	})
	return file_bze_epoch_epoch_proto_rawDescData
}

var file_bze_epoch_epoch_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_bze_epoch_epoch_proto_goTypes = []interface{}{
	(*EpochInfo)(nil),             // 0: bze.epoch.EpochInfo
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 2: google.protobuf.Duration
}
var file_bze_epoch_epoch_proto_depIdxs = []int32{
	1, // 0: bze.epoch.EpochInfo.start_time:type_name -> google.protobuf.Timestamp
	2, // 1: bze.epoch.EpochInfo.duration:type_name -> google.protobuf.Duration
	1, // 2: bze.epoch.EpochInfo.current_epoch_start_time:type_name -> google.protobuf.Timestamp
...
func init() { file_bze_epoch_epoch_proto_init() }
func file_bze_epoch_epoch_proto_init() {
	if File_bze_epoch_epoch_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bze_epoch_epoch_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bze_epoch_epoch_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bze_epoch_epoch_proto_goTypes,
		DependencyIndexes: file_bze_epoch_epoch_proto_depIdxs,
		MessageInfos:      file_bze_epoch_epoch_proto_msgTypes,
	}.Build()
	File_bze_epoch_epoch_proto = out.File
	file_bze_epoch_epoch_proto_rawDesc = nil
	file_bze_epoch_epoch_proto_goTypes = nil
	file_bze_epoch_epoch_proto_depIdxs = nil
}
