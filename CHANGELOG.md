...
* (x/rewards) [#100](https://github.com/bze-alphateam/bze/pull/100) Denom Rewards params migration: rewards module consensus version 4→5 sets the seven new `denom reward` parameter defaults (creation/prize/schedule fees, prize-denom cap, exit gas, lock, min stake), wired to the new `v8.2.0` upgrade handler.
