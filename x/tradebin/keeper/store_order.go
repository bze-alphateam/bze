...
func (k Keeper) getOrderStore(ctx sdk.Context) prefix.Store {
	return k.getPrefixedStore(ctx, types.KeyPrefix(types.OrderKeyPrefix))
}

func (k Keeper) getUserOrderStore(ctx sdk.Context) prefix.Store {
	return k.getPrefixedStore(ctx, types.KeyPrefix(types.UserOrderKeyPrefix))
}

func (k Keeper) getUserOrderByAddressStore(ctx sdk.Context, address string) prefix.Store {
	return k.getPrefixedStore(ctx, types.UserOrderByUserPrefix(address))
}

func (k Keeper) getUserOrderByAddressAndMarketStore(ctx sdk.Context, address, marketId string) prefix.Store {
	return k.getPrefixedStore(ctx, types.UserOrderByUserAndMarketPrefix(address, marketId))
}

func (k Keeper) getPriceOrderStore(ctx sdk.Context) prefix.Store {
	return k.getPrefixedStore(ctx, types.KeyPrefix(types.PriceOrderKeyPrefix))
}

func (k Keeper) getAggregatedOrderStore(ctx sdk.Context) prefix.Store {
	return k.getPrefixedStore(ctx, types.KeyPrefix(types.AggOrderKeyPrefix))
}

func (k Keeper) getAggregatedOrderByMarketAndTypeStore(ctx sdk.Context, marketId, orderType string) prefix.Store {
	return k.getPrefixedStore(ctx, types.AggOrderByMarketAndTypePrefix(marketId, orderType))
}

func (k Keeper) getOrderCounterStore(ctx sdk.Context) prefix.Store {
	return k.getPrefixedStore(ctx, types.KeyPrefix(types.OrderCounterPrefix))
}
...
func (k Keeper) GetPriceOrderByPrice(ctx sdk.Context, marketId, orderType, price string) (list []types.OrderReference) {
	store := k.getPriceOrderStore(ctx)
	iterator := storetypes.KVStorePrefixIterator(store, types.PriceOrderPrefixKey(marketId, orderType, price))
