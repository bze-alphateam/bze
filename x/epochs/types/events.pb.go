...
func (*EpochStartEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_da0328d26f1c172f, []int{0}
}
...
func (*EpochEndEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_da0328d26f1c172f, []int{1}
}
...
func init() {
	proto.RegisterType((*EpochStartEvent)(nil), "bze.epochs.EpochStartEvent")
	proto.RegisterType((*EpochEndEvent)(nil), "bze.epochs.EpochEndEvent")
}

func init() { proto.RegisterFile("bze/epochs/events.proto", fileDescriptor_da0328d26f1c172f) }

var fileDescriptor_da0328d26f1c172f = []byte{
	// 200 bytes of a gzipped FileDescriptorProto
	,
}
