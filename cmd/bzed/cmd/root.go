...
func NewRootCmd(
	...
	encodingConfig := params.MakeEncodingConfig(moduleBasics)
...
func SetPrefixes(accountAddressPrefix string) {
	...
	// Set and seal config
	configs := sdk.GetConfig()
	configs.SetBech32PrefixForAccount(accountAddressPrefix, accountPubKeyPrefix)
	configs.SetBech32PrefixForValidator(validatorAddressPrefix, validatorPubKeyPrefix)
	configs.SetBech32PrefixForConsensusNode(consNodeAddressPrefix, consNodePubKeyPrefix)
	configs.Seal()
}
