...
// NewRootCmd creates a new root command for beezeed. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	// This needs to be removed after IBC/wasm supports App Wiring.
