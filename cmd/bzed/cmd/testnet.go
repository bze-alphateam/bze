...
func initGenFiles(
	...
	// ALLIANCE
	var burnerGenState burnermoduletypes.GenesisState
	clientCtx.Codec.MustUnmarshalJSON(appGenState[burnermoduletypes.ModuleName], &burnerGenState)
	burnerParams := burnerGenState.GetParams()
	burnerGenState.Params = burnerParams
	appGenState[burnermoduletypes.ModuleName] = clientCtx.Codec.MustMarshalJSON(&burnerGenState)
