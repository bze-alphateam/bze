...
func (n *internalNode) buildCreateValidatorMsg(amount sdk.Coin) (sdk.Msg, error) {
	...
	return stakingtypes.NewMsgCreateValidator(
		sdk.ValAddress(n.keyInfo.Address),
		valPubKey,
		amount,
		description,
		commissionRates,
...
func (n *internalNode) createAppConfig(nodeConfig *NodeConfig) {
	...
	appConfig.MinGasPrices = fmt.Sprintf("%s%s", MinGasPrice, BzeDenom)
...
func (n *internalNode) createKeyFromMnemonic(name, mnemonic string) error {
	...
	kb, err := keyring.New(keyringAppName, keyring.BackendTest, n.configDir(), nil, cdc)
	if err != nil {
		return err
	}
...
func (n *internalNode) export() *Node {
	return &Node{
		...
		Mnemonic:      n.mnemonic,
		PublicAddress: n.keyInfo.Address.String(),
		PublicKey:     n.keyInfo.PubKey.Address().String(),
		PeerId:        n.peerId,
...
func (n *internalNode) init() error {
	...
	appState, err := json.MarshalIndent(bzeApp.ModuleBasics.DefaultGenesis(util.Cdc), "", " ")
	if err != nil {
