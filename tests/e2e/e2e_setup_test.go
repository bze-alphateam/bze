...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	// 4. Execute various e2e tests, including IBC, upgrade.
	...
	if str := os.Getenv("BZE_E2E_SKIP_STATE_SYNC"); len(str) > 0 {
	...
	if str := os.Getenv("BZE_E2E_DEBUG_LOG"); len(str) > 0 {
