...
const baseMsgCreateDenomResponse: object = { newDenom: "" };
...
export const MsgCreateDenomResponse = {
  ...
  fromJSON(object: any): MsgCreateDenomResponse {
    const message = { ...baseMsgCreateDenomResponse } as MsgCreateDenomResponse;
    if (object.newDenom !== undefined && object.newDenom !== null) {
      message.newDenom = String(object.newDenom);
    } else {
      message.newDenom = "";
    }
    return message;
  ...
  toJSON(message: MsgCreateDenomResponse): unknown {
    const obj: any = {};
    message.newDenom !== undefined && (obj.newDenom = message.newDenom);
    return obj;
  },
